    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-24 pb-20 md:pt-40 md:pb-32 px-4 z-40 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden -z-10 bg-slate-50 flex items-center justify-center">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200vw] h-[200vw] md:w-[150vw] md:h-[150vw] opacity-[0.20] animate-[spin_180s_linear_infinite]"
            style={{
      ...
      <section className="px-4 pb-24 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {[
            ...
            <div
              key={i}
              className="surface-card p-6 md:p-8 rounded-[24px] flex flex-col items-center text-center"
            >
              <div className="w-14 h-14 bg-cyan-600 text-white rounded-2xl flex items-center justify-center mb-4 shadow-cyan-200 shadow-md">
                {item.icon}
              </div>
